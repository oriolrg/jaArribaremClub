    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <div class="col py-3"><!--La equita id debe ser app, como hemos visto en app.js-->
                <div class="container">
                        <h2>Fotos</h2> 
                        <a href="fotos/nou" class="btn btn-success col-12" >
                            <b><i class="bi bi-patch-plus"> Nova Foto</i></b>
                        </a>
                        <ul class="list-group cProductsList"> 
                            @foreach($colaboradors as $key => $data)
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm">
                                                        <a href="{{ route('home.fotos.fotosEditar', $data->id) }}" class="btn btn-primary col-sm" >
                                                            <i class="bi bi-gear-wide"> Editar </i>
                                                        </a>
                                                    </div>
                                                    <div class="col-sm">
                                                        <form action="{{ route('home.fotos.fotosBorrar', $data->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
