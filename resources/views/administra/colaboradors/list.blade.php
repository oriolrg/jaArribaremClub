                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col-sm">
                                                        <a href="{{ route('home.colaboradors.colaboradorsEditar', $data->id) }}" class="btn btn-primary col-sm" >
                                                            <i class="bi bi-gear-wide"> Editar </i>
                                                        </a>
                                                    </div>
                                                    <div class="col-sm">
                                                        <form action="{{ route('home.colaboradors.colaboradorsBorrar', $data->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
